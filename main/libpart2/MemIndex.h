...
#ifndef HW2_PUBLIC_MEMINDEX_H_
#define HW2_PUBLIC_MEMINDEX_H_

#include <stdbool.h>

#include "../libpart1/HashTable.h"
#include "../libpart1/LinkedList.h"
#include "DocTable.h"
...
//
// Although C is a procedural language, part1 demonstrated that we could
...
//
// Clients will need to break the MemIndex abstraction by directly
