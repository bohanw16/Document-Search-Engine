...
#ifndef LAYOUTSTRUCTS_H_
#define LAYOUTSTRUCTS_H_
...
// This header file defines the in-memory structs representing part3 on-disk
...
// exactly to the file format described in the part3 spec.
...
struct HashTableHeader {
  ...
  HashTableHeader() { }  // this constructor doesn't initialize numBuckets!

  explicit HashTableHeader(int32_t num_buckets_arg)
